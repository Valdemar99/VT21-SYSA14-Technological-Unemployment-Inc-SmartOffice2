...
namespace SmartOfficeApplication
{
    class ErrorHandler
    {
        public string ErrorHandling(int errorCode, string objectName, string keyName)
        {
            ...
            if (errorCode == 2627)
            {
                returnString = "There alreade exist a " + objectName + " with this " + keyName + " value.";
            }
            else if (errorCode == 0)
            {
                returnString = "There is a problem with the connection, please check your internet connection and try again. " +
            ...
            {
                returnString = "One of the entered values does not exist.";
            }
